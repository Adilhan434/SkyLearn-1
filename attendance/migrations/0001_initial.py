    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson_time', models.ForeignKey(blank=True, help_text='Время урока (автоматически определяет start и end)', null=True, on_delete=django.db.models.deletion.CASCADE, to='attendance.lessontime')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shcedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='attendance.scheduleitem')),
            ],
        ),
    ]
